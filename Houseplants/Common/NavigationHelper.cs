...
namespace Houseplants.Common
{
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        RelayCommand0 _goBackCommand;
        RelayCommand0 _goForwardCommand;

        /// <summary>
        /// <see cref="RelayCommand0"/> used to bind to the back Button's Command property
        /// for navigating to the most recent item in back navigation history, if a Frame
        /// manages its own navigation history.
        /// 
        /// The <see cref="RelayCommand0"/> is set up to use the virtual method <see cref="GoBack"/>
        /// as the Execute Action and <see cref="CanGoBack"/> for CanExecute.
        /// </summary>
        public RelayCommand0 GoBackCommand
        {
            get
            {
                if (_goBackCommand == null)
                {
                    _goBackCommand = new RelayCommand0(
                        () => this.GoBack(),
                        () => this.CanGoBack());
                }
        ...
        /// <summary>
        /// <see cref="RelayCommand0"/> used for navigating to the most recent item in 
        /// the forward navigation history, if a Frame manages its own navigation history.
        /// 
        /// The <see cref="RelayCommand0"/> is set up to use the virtual method <see cref="GoForward"/>
        /// as the Execute Action and <see cref="CanGoForward"/> for CanExecute.
        /// </summary>
        public RelayCommand0 GoForwardCommand
        {
            get
            {
                if (_goForwardCommand == null)
                {
                    _goForwardCommand = new RelayCommand0(
                        () => this.GoForward(),
                        () => this.CanGoForward());
                }
